...
const Nav = () => {
  ...
  return (
    <nav ref={navRef} className="flex flex-shrink-0 flex-col items-center xl:justify-center gap-y-4 fixed h-max bottom-0 mt-auto xl:right-[2%] z-30 w-full xl:w-16 xl:max-w-md xl:h-screen">
